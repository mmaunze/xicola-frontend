...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'pagamentos-detalhes-id': RouteRecordInfo<'pagamentos-detalhes-id', '/pagamentos/detalhes/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'pagamentos-pagamento-editar-id': RouteRecordInfo<'pagamentos-pagamento-editar-id', '/pagamentos/pagamento/editar/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'pagamentos-registar': RouteRecordInfo<'pagamentos-registar', '/pagamentos/registar', Record<never, never>, Record<never, never>>,
