<script setup>
import InvoiceAddPaymentDrawer from "@/views/pagamentos/InvoiceAddPaymentDrawer.vue";
...
const route = useRoute("pagamentos-edit-id");
const { data: invoiceDetails } = await useApi(
